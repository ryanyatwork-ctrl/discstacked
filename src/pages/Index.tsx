...
function dbToMediaItem(db: DbMediaItem): MediaItem {
  ...
  return {
    ...
    contentType: (db as any).content_type ?? undefined,
    tmdbSeriesId: (db as any).tmdb_series_id ?? null,
    seasonNumber: (db as any).season_number ?? null,
    episodeCount: (db as any).episode_count ?? null,
